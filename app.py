...
with open('onehit_encoder_geo.pkl','rb') as file:
...
#Combining this with input data
...
st.write(f'Probability obtained: ', prediction_probability)

if prediction[0][0] > 0.5:
    st.write('Customer likely to churn')
else:
    st.write('Customer not likely churn')